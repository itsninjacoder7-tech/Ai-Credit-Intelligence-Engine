...
border-radius:10px; background:rgba(78,161,255,0.08); border:1px solid rgba(78,161,255,0.2);">
...
style="display:flex; align-items:center; justify-content:center; width:36px; height:36px;
border-radius:10px; background:rgba(255,255,255,0.05); border:1px solid rgba(255,255,255,0.15);">
